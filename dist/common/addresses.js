...
exports.RoyaltyRegistry = exports.Routers = exports.Usdc = exports.Weth = exports.Eth = void 0;
...
exports.Eth = {
    ...
    [utils_1.Network.EthereumKovan]: constants_1.AddressZero,
    [utils_1.Network.OptimismKovan]: constants_1.AddressZero,
    [utils_1.Network.Gnosis]: constants_1.AddressZero,
    [utils_1.Network.Polygon]: constants_1.AddressZero,
    [utils_1.Network.Arbitrum]: constants_1.AddressZero,
    [utils_1.Network.AvalancheFuji]: constants_1.AddressZero,
    [utils_1.Network.Avalanche]: constants_1.AddressZero,
    [utils_1.Network.PolygonMumbai]: constants_1.AddressZero,
};
exports.Weth = {
    ...
    [utils_1.Network.Optimism]: "0x4200000000000000000000000000000000000006",
    [utils_1.Network.OptimismKovan]: "0x4200000000000000000000000000000000000006",
    [utils_1.Network.Gnosis]: "0x6a023ccd1ff6f2045c3309768ead9e68f978f6e1",
    [utils_1.Network.Arbitrum]: "0x82af49447d8a07e3bd95bd0d56f35241523fbab1",
    // Polygon: Wrapped MATIC
    [utils_1.Network.Polygon]: "0x0d500b1d8e8ef31e21c99d1db9a6444d3adf1270",
    [utils_1.Network.PolygonMumbai]: "0x9c3c9283d3e44854697cd22d3faa240cfb032889",
    // Avalanche: Wrapped AVAX
    [utils_1.Network.Avalanche]: "0xb31f66aa3c1e785363f0875a1b74e27b85fd66c7",
    [utils_1.Network.AvalancheFuji]: "0x1d308089a2d1ced3f1ce36b1fcaf815b07217be3",
};
