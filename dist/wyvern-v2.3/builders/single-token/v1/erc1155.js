...
exports.SingleTokenErc1155BuilderV1 = void 0;
...
"0x00000000" +
    ...
    // empty `data` (required)
    "0".repeat(128);
class SingleTokenErc1155BuilderV1 extends base_1.BaseBuilder {
    constructor(chainId) {
        super(chainId);
    }
    getInfo(order) {
        try {
            const result = new abi_1.Interface(Erc1155_json_1.default).decodeFunctionData("safeTransferFrom", order.params.calldata);
            return {
    ...
    build(params) {
        ...
        if (params.side === "buy") {
            return new order_1.Order(this.chainId, {
                ...
                calldata: new abi_1.Interface(Erc1155_json_1.default).encodeFunctionData("safeTransferFrom", [
            ...
            return new order_1.Order(this.chainId, {
                ...
                target: params.contract,
                howToCall: Types.OrderHowToCall.CALL,
                calldata: new abi_1.Interface(Erc1155_json_1.default).encodeFunctionData("safeTransferFrom", [params.maker, constants_1.AddressZero, params.tokenId, 1, "0x"]),
...
exports.SingleTokenErc1155BuilderV1 = SingleTokenErc1155BuilderV1;
