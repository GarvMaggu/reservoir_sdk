...
exports.ContractWideErc721Builder = void 0;
...
"0x00000000" +
    ...
    // `tokenId` (empty)
    "f".repeat(64);
class ContractWideErc721Builder extends base_1.BaseBuilder {
    constructor(chainId) {
        super(chainId);
    }
    getInfo(order) {
...
exports.ContractWideErc721Builder = ContractWideErc721Builder;
