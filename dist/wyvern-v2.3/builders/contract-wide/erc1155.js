...
exports.ContractWideErc1155Builder = void 0;
const abi_1 = require("@ethersproject/abi");
const constants_1 = require("@ethersproject/constants");
const base_1 = require("../base");
const erc1155_1 = require("../single-token/v1/erc1155");
...
"0x00000000" +
    ...
    // empty `data` (required)
    "0".repeat(128);
class ContractWideErc1155Builder extends base_1.BaseBuilder {
    constructor(chainId) {
        super(chainId);
    }
    getInfo(order) {
    ...
    build(params) {
        ...
        if (params.side === "buy") {
            return new order_1.Order(this.chainId, {
                ...
                calldata: new abi_1.Interface(Erc1155_json_1.default).encodeFunctionData("safeTransferFrom", [constants_1.AddressZero, (_a = params.recipient) !== null && _a !== void 0 ? _a : params.maker, 0, 1, "0x"]),
    ...
    buildMatching(order, taker, data) {
        ...
        if (order.params.side === Types.OrderSide.BUY) {
            const singleTokenBuilder = new erc1155_1.SingleTokenErc1155BuilderV1(this.chainId);
...
exports.ContractWideErc1155Builder = ContractWideErc1155Builder;
