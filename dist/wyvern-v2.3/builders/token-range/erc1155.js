...
exports.TokenRangeErc1155Builder = void 0;
...
"0x00000000" +
    ...
    // empty `data` (required)
    "0".repeat(128);
class TokenRangeErc1155Builder extends base_1.BaseBuilder {
    constructor(chainId) {
        super(chainId);
    }
    getInfo(order) {
...
exports.TokenRangeErc1155Builder = TokenRangeErc1155Builder;
